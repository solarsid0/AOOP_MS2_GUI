...
public class AdminIT extends JFrame {
    ...
    public AdminIT(UserAuthenticationModel user) {
        this.loggedInUser = user;
        
        if (!hasITAccess(user)) {
            JOptionPane.showMessageDialog(null, 
                "Access denied! You don't have permission to access the IT module.", 
                "Access Denied", 
    ...
    private boolean hasITAccess(UserAuthenticationModel user) {
        ...
        // Check if role contains IT or ADMIN
        return upperRole.contains("IT") || upperRole.contains("ADMIN");
    }
    

    private void updateLabels() {
        // Since this is AdminIT class, always show "IT Dashboard"
        lblWelcomeMessage.setText("IT Dashboard");
    ...
    private void initComponents() {
        ...
        userManagement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media/password.png"))); // NOI18N
        ...
        emppagemainPNL.add(userManagement);
        userManagement.setBounds(630, 140, 270, 80);
