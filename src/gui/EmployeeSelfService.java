...
public class EmployeeSelfService extends JFrame {
    ...
    public EmployeeSelfService(UserAuthenticationModel user) {
        ...
        setTitle("MotorPH Employee Self-Service | Welcome, " + user.getFirstName() + " " + user.getLastName() + "!");
    ...
    private boolean hasEmployeeAccess(UserAuthenticationModel user) {
        return user != null && user.getEmployeeId() > 0;
    }
    

    private void updateLabels() {
        // Since this is EmployeeSelfService class, always show "Employee Dashboard"
        lblWelcomeMessage.setText("Employee Dashboard");
    ...
    private void initComponents() {
        ...
        MotorPHLogo.setBounds(706, 50, 124, 90);
