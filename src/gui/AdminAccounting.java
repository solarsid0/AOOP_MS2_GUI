...
public class AdminAccounting extends JFrame {
    private UserAuthenticationModel loggedInUser;
    private Timer timer;
    
    public AdminAccounting(UserAuthenticationModel user) {
        this.loggedInUser = user;
        
        if (!hasAccountingAccess(user)) {
            JOptionPane.showMessageDialog(null, 
                "Access denied! You don't have permission to access the Accounting module.", 
                "Access Denied", 
    ...
    private boolean hasAccountingAccess(UserAuthenticationModel user) {
        ...
        // Check if role contains ACCOUNTING, ADMIN, or HR
        return upperRole.contains("ACCOUNTING") || 
    ...
    private void updateLabels() {
        if (loggedInUser != null) {
            // Since this is AdminAccounting class, always show "Accounting Dashboard"
            lblWelcomeMessage.setText("Accounting Dashboard");
            jLabelEmpName.setText("Welcome, " + loggedInUser.getFirstName() + " " + loggedInUser.getLastName());
        } else {
            lblWelcomeMessage.setText("Accounting Dashboard");
            jLabelEmpName.setText("Welcome, Admin");
        }
    }
    ...
    private void updateDateTime() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(() -> dateTimejLabel.setText(formattedDate));
            }
        }, 0, 1000);
    }
    ...
    private void initComponents() {
        ...
        MotorPHLogo.setBounds(766, 30, 124, 90);
        ...
        payrollManagement.setForeground(new java.awt.Color(255, 255, 255));
        payrollManagement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media/accounting.png"))); // NOI18N
        payrollManagement.setText("Payroll Management");
        payrollManagement.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                payrollManagementActionPerformed(evt);
            }
        });
   ...
   public static void main(String args[]) {
    ...
    private javax.swing.JButton payrollManagement;
