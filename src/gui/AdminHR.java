...
public class AdminHR extends JFrame {
    ...
    public AdminHR(UserAuthenticationModel user) {
        this.loggedInUser = user;
        
        if (!hasHRAccess(user)) {
            JOptionPane.showMessageDialog(null, 
                "Access denied! You don't have permission to access the HR module.", 
                "Access Denied", 
    ...
    private boolean hasHRAccess(UserAuthenticationModel user) {
        ...
        // Check if role contains HR or ADMIN
    ...
    private void updateLabels() {
        ...
        String displayRole = getPrimaryRoleForDisplay(loggedInUser.getUserRole());
        lblWelcomeMessage.setText(displayRole + " Dashboard");
        jLabelEmpName.setText("Welcome, " + loggedInUser.getFirstName() + " " + loggedInUser.getLastName());
    }

    /**
     * Extract the primary role for clean dashboard display
     * Priority: HR > Accounting > IT > Supervisor > Employee
     */
    private String getPrimaryRoleForDisplay(String fullRole) {
        if (fullRole == null) return "User";

        String upperRole = fullRole.toUpperCase();

        // Check for major roles first (these take precedence)
        if (upperRole.contains("HR")) {
            ...
            return "IT";
        } else if (upperRole.contains("SUPERVISOR") || upperRole.contains("MANAGER")) {
            return "Supervisor";
